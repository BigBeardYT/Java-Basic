...
//        System.out.println(p.getString());
        ...
        // 在Person类中重写了toString方法，如果不重写，会直接调用Object类中的toString()方法：getClass().getName() + ‘@’ + Integer.toHexString(hashCode())
        ...
        System.out.println("与直接调用的p比较结果: " + a);    // falst
        System.out.println("与使用p调用toString()方法的结果: " + b);  //true
